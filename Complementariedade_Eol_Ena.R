...
library(Kendall)
#urlPackage <- "https://cran.r-project.org/src/contrib/Archive/pear/pear_1.2.tar.gz"
...
setwd('C:/Users/ami/OneDrive - Elera/Documentos/00. Pastas e Arquivos antigos/16. Doutorado/00. Material para a Tese/03. Dados/Dados_R')
#
...
dados_eol <- read_excel("Alto Sertão_Valores.xlsx", sheet = "Candiba")
